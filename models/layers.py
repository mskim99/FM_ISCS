    ...
    def __init__(
        ...
        if resample == "down":
            if dilation > 1:
                ...
                self.conv2 = ncsn_conv3x3(input_dim, output_dim, dilation=dilation, padding=dilation)
                conv_shortcut = partial(ncsn_conv3x3, dilation=dilation, padding=dilation)
            else:
                self.conv1 = ncsn_conv3x3(input_dim, input_dim)
                self.normalize2 = normalization(input_dim)
                self.conv2 = ConvMeanPool(input_dim, output_dim, 3, adjust_padding=adjust_padding)
            ...
            if dilation > 1:
                conv_shortcut = partial(ncsn_conv3x3, dilation=dilation, padding=dilation)
                self.conv1 = ncsn_conv3x3(input_dim, output_dim, dilation=dilation, padding=dilation)
                self.normalize2 = normalization(output_dim)
                self.conv2 = ncsn_conv3x3(output_dim, output_dim, dilation=dilation, padding=dilation)
            else:
